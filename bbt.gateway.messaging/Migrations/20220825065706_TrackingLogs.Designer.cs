...
namespace bbt.gateway.messaging.Migrations
{
    ...
    [Migration("20220825065706_TrackingLogs")]
    partial class TrackingLogs
    {
            ...
            modelBuilder.Entity("bbt.gateway.common.Models.Header", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7199257c-d3ec-4064-9fca-e5f344df0c44"),
                            ContentType = 4,
                            SmsPrefix = "",
                            SmsSender = 1,
                            SmsSuffix = ""
                        ...
                        new
                        {
                            Id = new Guid("bb5bf16b-3eaa-4b9d-933a-1bf4c42dc631"),
                            Branch = 2000,
                            ContentType = 1,
                            SmsPrefix = "",
                            SmsSender = 2
            ...
            modelBuilder.Entity("bbt.gateway.common.Models.MailTrackingLog", b =>
                {
                    ...
                    b.Property<Guid?>("MailResponseLogId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("bbt.gateway.common.Models.SmsTrackingLog", b =>
                {
                    ...
                    b.Property<Guid?>("SmsResponseLogId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("bbt.gateway.common.Models.MailTrackingLog", b =>
                {
                    b.HasOne("bbt.gateway.common.Models.MailResponseLog", "MailResponseLog")
                        ...
                        .HasForeignKey("MailResponseLogId");
            ...
            modelBuilder.Entity("bbt.gateway.common.Models.SmsTrackingLog", b =>
                {
                    b.HasOne("bbt.gateway.common.Models.SmsResponseLog", "SmsResponseLog")
                        .WithMany("TrackingLogs")
                        .HasForeignKey("SmsResponseLogId");

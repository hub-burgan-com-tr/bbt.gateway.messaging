        ...
        public async Task RemindAsync(string subject, string content, List<common.Models.Attachment> attachments)
        {
            if (System.Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT") == "Test")
            {
                try
                {
                    ...
                    var rt = await _operatordEngage.SendMail(_configuration["InstantReminder:To"], "noreplay@m.burgan.com.tr", subject, content, null, null, attachments, null, null, null, checkIsVerified: false);
